...
{   
    ...
    string Name_output(filePath);
    cout<<Name_output<<endl;
    Name_output.erase(Name_output.size()-2,2);
    cout<<Name_output<<endl;
    Name_output.append(".o");
    cout<<Name_output<<endl;

	// write File
	ofstream writeFile(Name_output);
	if( writeFile.is_open() )
    {
        ...
        for (int i=0; i<word_directives.size(); i++)
        {
            ...
            {
                int num = atoi(word_directives[i].c_str());//string을 int로
